...
/**
 * This class is changed depending on if we are in Android or Java. Amongst
 * other things it lets us change the base class for tests between TestCase
 * (Java) and AndroidTestCase (Android).
 * 
 * Reference Issue:
...
public class LiteTestCaseBase extends TestCase {
	...
	protected void setUp() throws Exception {
		super.setUp();
		// We have to tell the log handlers to output everything or any logging
		// events below info won't be logged
		// Taken from
